...
I am particularly interested in memory --- how we can design proper structure and algorithm to make it robust (order insensitive), elastic (easily updatable), and persistent (minimal forget).
