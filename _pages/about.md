...
My research goal is to build controllable agents that can operate on a long interactive horizon and evolve over time.
I am particularly interested in *memory* --- how we can design proper structure and algorithm to make it elastic and can self-reorganize (easily updatable), robust (insensitive to perturbation), and persistent (minimal forget).
